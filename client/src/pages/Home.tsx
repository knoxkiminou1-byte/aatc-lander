      ...
      <footer className="bg-black text-gray-400 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              <h4 className="text-white text-lg font-bold mb-4 tracking-normal" style={{fontFamily: 'Merriweather, serif'}}>About AAFC</h4>
            ...
            <div>
              <h4 className="text-white text-lg font-bold mb-4 tracking-normal" style={{fontFamily: 'Merriweather, serif'}}>Programs</h4>
            ...
            <div>
              <h4 className="text-white text-lg font-bold mb-4 tracking-normal" style={{fontFamily: 'Merriweather, serif'}}>Get Involved</h4>
              <ul className="text-sm space-y-2">
